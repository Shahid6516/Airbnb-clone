...
const Listingpage2 = () => {
  ...
  return (
    <div className="w-[100%] h-[100vh] flex items-center justify-center bg-white relative ">
      ...
      <div className="max-w-[900px] w-[100%] h-[550px] overflow-auto flex items-center justify-center flex-col gap-[40px] mt-[50px]">
        ...
        <div className="max-w-[900px] w-[100%] h-[100%] flex flex-wrap items-center justify-center gap-[15px] md:w-[65%] ">
          ...
          <div className="w-[180px] h-[100px] flex justify-center items-center flex-col cursor-pointer border-1 hover:border-[#a6a5a5] text-[16px] rounded-lg ">
        ...
        <button className="px-[50px] py-[10px] bg-red-600 absolute right-[5%] bottom-[9%] text-white rounded-lg md:px-[100px]">
          Next
        </button>
      </div>
    </div>
